...
#Plot residuals
residual_plot = function(test, XGBPredsTest, test_glm){ 
    ...
    #df for glm
    glmResids = tibble(Residuals = test_glm - test$two_week_outcome,
                       Model = "GLM")
...
results_tabular_all = function(XGBPredsPred, preds_glm, test, XGBRMSE, BLRMSE, GLMRMSE){
...
#Results table
results_tabular_all(XGBPredsPred, preds_glm, test, XGBRMSE, BLRMSE, GLMRMSE)
#Residual Density Plot - no need to save to variable
residual_plot(test, XGBPredsTest, test_glm)
#Map RMSE to state 
