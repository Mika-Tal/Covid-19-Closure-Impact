...
For the time period from March 1, 2020 to April 30, 2020, the RMSE of the "treatment" only variables is0.5833348, when we only include the binary closure variables, which suggests that these variables only (SANS controls) are not particularly good predictors of the incidence of new deaths.
