...
date_hold<- features1$date
two_week_forecast_date<-features1$two_week_forecast_date
drops<-c( "date", "two_week_forecast_date") #droping 
...
glm_feats<-cbind(feat_v2(features1, 2:end), date_hold, two_week_forecast_date) #do not include y or "id" in poly calcs
